...
module.exports = () => {
    ...
    const init = async () => {
        ...
        const events = await readdirSync(`${__dirname}/events/`).filter(file => file.endsWith(".js"));
        ...
        const providedEvents = await readdirSync(`${__dirname}/providedEvents/`).filter(file => file.endsWith(".js"));
